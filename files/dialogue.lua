...
Custom_speak_lines = {
    ...
    {"minitank", "AAA batteries do not last that long, unfortunately.", "Pew pew pew.", "A little bit of magic can go a long way.", "Circuit boards and computer chips... Everything that is 'me'.", "Regular tanks are big and heavy. How inefficient.", "I am not a wind-up toy. What a shame."},
}
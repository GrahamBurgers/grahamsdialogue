...
Custom_speak_lines = {
    ...
    {"tipsy_ghost", "Hurp... You can c-count on me, boss...", "G-glad to be here.", "Got any spare whiskey or sima? I'll m-make it worth your while.", "I can do lots of stuff! If my head is clear...", "I'm a spirit spirit! Get it...?", "Stay away from my whiskey! ...For your health, that is."},
    ...
    {"lukki_mount_on", "Alright! Where are we headed?", "Sit back and relax. This'll be a smooth ride.", "Away we go! Just tell me where to go."},
    {"lukki_mount_off", "I'll stay close. And maybe bite some stuff.", "What are you up to? Can I see?", "Stay safe. If you need help, I won't be far."},
